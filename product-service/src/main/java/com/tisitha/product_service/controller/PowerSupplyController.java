...
public class PowerSupplyController {
    ...
    public ResponseEntity<PowerSupplyResponseDTO> add(@Valid @RequestBody PowerSupplyRequestDTO dto){
    ...
    public ResponseEntity<PowerSupplyResponseDTO> update(@PathVariable UUID id,@Valid @RequestBody PowerSupplyRequestDTO dto){
